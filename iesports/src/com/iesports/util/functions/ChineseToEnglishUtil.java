 ...
 * 描述：中文转英语帮助工具类
 * @author xiongdun
 * @created 2016年9月20日 上午8:42:14
 * @since 
 */
public class ChineseToEnglishUtil {
	
	private static Logger logger = Logger.getLogger(ChineseToEnglishUtil.class);
    ...
    public static void main(String[] args) {  
        String str = "中华人明共和国";  
        // 转换成拼音  
        System.out.println(ChineseToEnglishUtil.getFullSpell(str));  
        // 中文第一个字全拼,其余去首字母  
        //System.out.println(ChineseToEnglishUtil.getFirstSpell(str));  
        // ascii 转 字母  
        //System.out.println(ChineseToEnglishUtil.getSpellByAscii(65));  
        // 字母 转 ascii  
        //System.out.println(ChineseToEnglishUtil.getCnAscii('0'));  
    }
}
