...
import com.iesports.test.carport.bean.OrgCarportResult;
...
import com.iesports.test.carport.service.impl.ApartmentServiceImpl;
import com.iesports.test.carport.service.impl.CarportServiceImpl;
import com.iesports.test.carport.service.impl.OrganizationServiceImpl;
import com.iesports.test.carport.service.impl.UserServiceImpl;
...
public class InitCarport {
	...
	private static String[] carport_NumArr = null;

	private static ApartmentService apService = new ApartmentServiceImpl();

	private static OrganizationService orgService = new OrganizationServiceImpl();

	private static CarportService carportService = new CarportServiceImpl();

	private static UserService userService = new UserServiceImpl();

	private static String apartment_no = TimerConfig.getString("start.init.apartment.number");
