...
public interface CarportHistoryMapper {
	 ...
	 * @return
	 */
	public List<CarportHistory> selectCarportHistoryByUserId(String user_id);
	 ...
	 * @return
	 */
	public CarportHistory selectCarportHistoryById(String cphis_id);
	 ...
	 * @return
	 */
	public int deleteCarportHistoryByCphisId(String cphis_id);
