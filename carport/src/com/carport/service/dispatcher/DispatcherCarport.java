...
import com.carport.service.impl.CarportHistoryServiceImpl;
...
public class DispatcherCarport {
	...
	private static String strDateBegin = Configuration.getString("carport.dispacher.begin");
	private static String strDateEnd = Configuration.getString("carport.dispacher.end");
