...
import com.carport.service.dispatcher.StartTimer;
...
public class TimerContextListener implements ServletContextListener {
	...
	public void contextInitialized(ServletContextEvent event) {
		...
		// 设置每天17点开始初始化车位表数据
		int hour = Configuration.getInt("start.timer.hour");
		int minute = Configuration.getInt("start.timer.minute");
		int second = Configuration.getInt("start.timer.second");
