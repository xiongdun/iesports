...
public interface ApartmentMapper {
	 ...
	 * 描述：查询状态为1的部门
	 * @author xiongdun
	 * @created 2016年12月15日 下午4:59:22
	 * @since 
	 * @return
	 */
	public List<Apartment> selectAllApartmentStatus1();
	/**
	 * 描述：按Id查询部门
	 * 
	 * @author zhangyijie
	 ...
	 * @return
	 */
	public Apartment selectApartmentById(@Param("apartment_id") String apartment_id);
	 ...
	 * @return
	 */
	public List<Apartment> selectApartmentByApNo(@Param("apartment_id") String apartment_no);
	 ...
	 * @return
	 */
	public int updateApartmentStatusTo1ById(@Param("apartment_id") String apartment_id);
	 ...
	 * @return
	 */
	public int updateApartmentStatusTo0ById(@Param("apartment_id") String apartment_id);
	 ...
	 * @return
	 */
	public int deleteApartmentInfoByApId(@Param("apartment_id") String apartment_id);
}
