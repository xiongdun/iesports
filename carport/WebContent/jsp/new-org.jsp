        	...
        	<div class="span9">
		  		<div class="row-fluid">
					<div class="page-header">
						<h1>新建机构 <small>add a new organization</small></h1>
					</div>
					<form class="form-horizontal" action="/carport/org/add#org" method="POST">
						<fieldset>
							...
							<div class="form-actions">
								<input type="submit" class="btn btn-success btn-large" value="保存组织" /> 
								<a class="btn" href="/carport/org/all#org">取消</a>
							</div>					
						</fieldset>
					</form>
		  		</div>
